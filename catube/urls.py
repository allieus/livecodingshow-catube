...
urlpatterns = [
    ...
    path('<int:video_pk>/comments/new/', views.CommentCreateView.as_view(), name='comment_new'),
    path('<int:video_pk>/comments/<int:pk>/delete/', views.CommentDeleteView.as_view(), name='comment_delete'),
]
